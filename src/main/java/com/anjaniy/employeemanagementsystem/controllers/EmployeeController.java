...
public class EmployeeController {
    ...
    @GetMapping("/groupBy/{departmentName}")
    public String getAllEmployeesByGroup(@PathVariable(value = "departmentName") String departmentName, Model model){
        model.addAttribute("listEmployees", employeeService.getAllEmployeesByGroup(departmentName));
        return "index.html";
    }
}
